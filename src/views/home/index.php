...
echo '<div style="padding: 300px; ">';
    <div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
        ...
        <main role="main" class="inner cover">
            ...
            <p class="lead">
                <br><p>This is the home page of the My PHrame application. </p>
            My PHrame is an freely available open source web development frame work with a low amount of code base.
            ...
            <br><p>You can change this home page and add your own home widgests. </p>
